...
-- FIXED VERSION: profiles table created BEFORE is_admin() function
-- (SQL-language functions resolve table references at CREATE time)
...
-- (Moved ABOVE is_admin() — the function references this table
--  and SQL-language functions are resolved at creation time.)
-- ─────────────────────────────────────────────────────────────
...
-- (Now created AFTER public.profiles exists.)
-- ─────────────────────────────────────────────────────────────
